...
# para crear una etiqueta en nuestra ventana: .Label
...
#para que aparezca la etiqueta en nuestra ventana: .pack (+ fill o side si queremos rellenarlo o cambiarlo de sitio)
etiqueta.pack()
...
def obtener_datos(nombre_entry, edad_entry, nueva_ventana):
...
boton2 = tk.Button(ventana, text = "Presiona para insertar datos", command = datos)
boton2.pack(pady = 10)
