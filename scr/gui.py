...
class ScrollApp:
    ...
    def _setup_canvas(self):
        ...
        self._my_canvas.bind(
            "<Configure>",
            lambda e: self._my_canvas.configure(
    ...
    def _show_introduction(self):
        ...
        messagebox.showinfo(
            ...
            "You can make predictions based on your model and also save it by pressing Download (you can add a comment of your choice).\n\n"
